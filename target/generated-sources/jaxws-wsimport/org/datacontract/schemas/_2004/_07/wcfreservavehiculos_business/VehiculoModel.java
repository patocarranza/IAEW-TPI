...
/**
 * <p>Clase Java para VehiculoModel complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="VehiculoModel">
 *   &lt;complexContent>
 ...
 *         &lt;element name="VehiculoCiudadId" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "VehiculoModel", propOrder = {
    "cantidadDisponible",
    "cantidadPuertas",
    "ciudadId",
    "id",
...
public class VehiculoModel {
    ...
    @XmlElementRef(name = "Marca", namespace = "http://schemas.datacontract.org/2004/07/WCFReservaVehiculos.Business.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> marca;
    @XmlElementRef(name = "Modelo", namespace = "http://schemas.datacontract.org/2004/07/WCFReservaVehiculos.Business.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> modelo;
    @XmlElement(name = "PrecioPorDia")
    protected BigDecimal precioPorDia;
    @XmlElementRef(name = "Puntaje", namespace = "http://schemas.datacontract.org/2004/07/WCFReservaVehiculos.Business.Entities", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "TipoCambio", namespace = "http://schemas.datacontract.org/2004/07/WCFReservaVehiculos.Business.Entities", type = JAXBElement.class, required = false)
    protected JAXBElement<String> tipoCambio;
    @XmlElement(name = "VehiculoCiudadId")
    protected Integer vehiculoCiudadId;
    ...
    /**
     * Obtiene el valor de la propiedad vehiculoCiudadId.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
    ...
    /**
     * Define el valor de la propiedad vehiculoCiudadId.
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setVehiculoCiudadId(Integer value) {
        this.vehiculoCiudadId = value;
    }
