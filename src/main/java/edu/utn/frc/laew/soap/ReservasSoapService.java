...
public class ReservasSoapService {
    ...
    public static Reserva reservarVehiculo(String apellidoNombreCliente, 
        ...
        JAXBElement<String> nom = ModelAdapters.createJAXBString("ApellidoNombreCliente", apellidoNombreCliente);        
        reservarVehiculoRequest.setApellidoNombreCliente(nom);
    ...
    public static Reserva cancelarReserva(String codReserva) 
        ...
        JAXBElement<String> codJax = ModelAdapters.createJAXBString("CodigoReserva", codReserva);
